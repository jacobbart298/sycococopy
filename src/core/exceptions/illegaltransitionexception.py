...
class IllegalTransitionException(SycococopyException):
    ...
    def __init__(self, transitionHistory: deque[tuple[int, Transition, any]]):
        self.transitionHistory: deque[tuple[int, Transition, any]] = transitionHistory
        
    def __str__(self) -> str:
        _, failedTransition, itemFailedTransition = self.transitionHistory[len(self.transitionHistory)-1]
